		...
		<div class="mx-auto max-w-4xl">
			<div class="grid gap-12 lg:grid-cols-5">
				...
				<div class="lg:col-span-2">
					...
					<div class="space-y-6">
						{#if pageSections?.contactInfo?.email && pageSections.contactInfo.email.trim() !== ''}
							<div class="flex items-start gap-4">
								...
								<div>
									...
									<a href="mailto:{pageSections.contactInfo.email}" class="text-destructive text-sm hover:underline"
										>{pageSections.contactInfo.email}</a
									>
								</div>
							</div>
						{/if}
						{#if pageSections?.contactInfo?.office && pageSections.contactInfo.office.trim() !== ''}
							<div class="flex items-start gap-4">
								<div
									class="bg-primary/10 flex h-10 w-10 shrink-0 items-center justify-center rounded-lg"
								>
								...
								<div>
									...
									<p class="text-muted-foreground text-sm whitespace-pre-line">
										{pageSections.contactInfo.office}
									</p>
								</div>
							</div>
						{/if}
						{#if pageSections?.contactInfo?.responseTime && pageSections.contactInfo.responseTime.trim() !== ''}
							<div class="flex items-start gap-4">
								<div
									class="bg-primary/10 flex h-10 w-10 shrink-0 items-center justify-center rounded-lg"
								>
								...
								<div>
									...
									<p class="text-muted-foreground text-sm">{pageSections.contactInfo.responseTime}</p>
								</div>
							</div>
						{/if}
					</div>
